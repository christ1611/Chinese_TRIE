...
int main()
{
	...
	const string directory2= mom_directory + "/Sogou/";
	const string directory = mom_directory+ "/Sogou";
	char *p;
	clock_t t1,t2;
	t1=clock();
	...
	maximal=0;
    cout<<endl;
	cout<<"type 0: train from Sogou, 1:train from model"<<endl;
	cin>>train_model;
	if (train_model==0)
    {
        ...
        else
        {
  		/* could not open directory */
            perror ("Please copy the sogou file to the folder, or if you have please change the name into 'Sogou'");
        }
        j=i;
        line="";
        k=0;
